    ...
    <section id="social-proof" className="bg-white px-5 py-12 sm:px-0 sm:py-20 lg:py-24">
      <div className="w-full px-0 sm:px-8 lg:px-12 xl:px-20">
        ...
        <div className="mt-12 max-w-full overflow-x-hidden [contain:layout_paint]">
          <div className="no-scrollbar flex w-full snap-x snap-mandatory gap-5 overflow-x-auto overscroll-x-contain pb-3 [contain:layout_paint] lg:grid lg:grid-cols-3 lg:gap-8 lg:overflow-visible lg:pb-0">
            {useCases.map((item) => (
              <article
                key={item.author}
